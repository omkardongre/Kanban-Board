...
export const routes: Routes = [
    ...
    {
        path: 'boards',
        loadComponent: () => import('./features/boards/list/list.component').then(m => m.ListComponent),
        canActivate: [authGuard]
    },
    {
        path: 'boards/:id',
        loadComponent: () => import('./features/boards/detail/detail.component').then(m => m.DetailComponent),
        canActivate: [authGuard]
    },
    {
        path: '**',
